...
const AlphaDepotCli = imports.cli.AlphaDepotCli;
const ByteArray = imports.byteArray;

const APP_NAME = "AlphaDepot";
...
const Application = new Lang.Class({
    ...
    _init: function() {
        this.application = new Gtk.Application({
            application_id: "com.alephalpha.alphadepot",
        ...
        this.cli = new AlphaDepotCliCli(this);
    ...
    _buildUI: function() {
        ...
        try {
            let icon = Gtk.IconTheme.get_default().load_icon("alphadepot", 48, 0);
    ...
    _renderPlugins: function() {
        ...
        for (let category of categories) {
            ...
            for (let item in this._plugins[category]) {
                ...
                print('AlphaDepot: loading plugin ' + plugin.category + '::' + plugin.label);
    ...
    _loadPlugins: function() {
        ...
        // User plugins
        let user = this._loadPluginsFromDir(GLib.get_user_data_dir() + "/alphadepot/plugins");
    ...
    _loadConfig: function() {
        ...
        // User config
        let user = this._loadJSON(GLib.get_user_data_dir() + "/alphadepot/config.json");
